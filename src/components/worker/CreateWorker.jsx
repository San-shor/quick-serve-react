...
export default function CreateWorker() {
  ...
  const handleCheckboxChange = (type) => {
    const current = formik.values.serviceType;
    const exists = current.includes(type);
    const next = exists
      ? current.filter((t) => t !== type)
      : [...current, type];
    formik.setFieldValue('serviceType', next);
  };
      ...
      <form className='space-y-4' onSubmit={formik.handleSubmit}>
        ...
        <div>
          <textarea
            ...
            className='w-full border border-gray-300 p-2 rounded-md focus:ring-2 focus:ring-blue-400 focus:outline-none'></textarea>
